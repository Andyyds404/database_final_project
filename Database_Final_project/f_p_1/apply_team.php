...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $tid = $_POST['tid'];
    $date = date('Y-m-d'); // null -> $date = date('Y-m-d');
    $stmt = $pdo->prepare("INSERT INTO TeamMembershipHistory (Team, Member, Join_Date) VALUES (?, ?, NULL)"); // Join_Date) VALUES (?, ?, NULL)"); -> Join_Date, Leave_Date) VALUES (?, ?, $date, NULL)");
